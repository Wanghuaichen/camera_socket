...
/** 
  ...
  */  
#define SD_CS_LOW()     GPIO_ResetBits(SD_SPI2_CS_GPIO_PORT, SD_SPI2_CS_PIN)
/** 
  * @brief  Deselect SD Card: ChipSelect pin high   
  */ 
#define SD_CS_HIGH()    GPIO_SetBits(SD_SPI2_CS_GPIO_PORT, SD_SPI2_CS_PIN)
/**
  * @}
  */ 
...
#define SD_SPI													SPI2
#define SD_SPI2_CLK                  		RCC_APB1Periph_SPI2
